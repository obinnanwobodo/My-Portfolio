        ...
        <div className={styles.contactgen}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.firsthandp}>
                    ...
                    <h1>Get In Touch</h1>
                    <p>I'm always open to discussing new opportunities, interesting projects, or just having  <span className={styles.span}>a conversation about technology</span></p>
                </div>

                <div className={styles.secondhandp}>
                    <h1>Let's Connect</h1>
                    <p>Whether you have a project in mind, want to collaborate, <br />or just want to say hello, I'd love to hear from you.<br /> Feel free to reach out through any of the channels below.</p>
                </div>
